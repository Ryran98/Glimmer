...
import supportImage from "../../images/home-support.jpg";
...
export class WelcomeBanner extends React.Component {
    render() {
        return (
            <Row>
                <Container className="col-6" style={welcomeBannerLeftStyle}>
                ...
                <div className="col-6" style={welcomeBannerRightStyle}></div>
            </Row>
        );
    }
}